# Repo Github de l'auteur: https://github.com/nejlag/Semi-Supervised-Learning-GAN
...
def plot_fake_data(data, grid_size = [5, 5], nb_epoch = 0):
    ...
    try:
        ...
        if e.errno != errno.EEXIST:
            raise
    plt.savefig('./results/{}_epoch.png'.format(nb_epoch))
    plt.close()
...
def train_SSL_GAN(batch_size, epochs):
    ...
    with tf.Session() as sess:
        ...
        for epoch in range(epochs):
            ...
            plot_fake_data(fakes, [5, 5], epoch)
